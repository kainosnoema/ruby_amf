...
class Test_RUBY_AMF_AMF3_dump < Test::Unit::TestCase
  ...
  def test_write_dynamic_object_type
    o = RubyAMF::Person.new
    o.name   = "Evan Owen"
    o.age    = 22
    o.gender = "m"

    assert_equal "\x0A\x0B\x39com.ekulnave.contacts.Person\x09name\x06\x13Evan Owen\x07age\x04\x16\x0dgender\x06\x03m\x15occupation\x01\x01", serialize(o)
  end
  
  # def test_write_object_ref
  #   n = '+32 488 478 282'
