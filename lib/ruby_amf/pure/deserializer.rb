module RubyAMF
  module Pure
    ...
    # AMF0 deserializer, switches over to AMF3 when needed
    class AMF0Deserializer
      ...
      def deserialize(source, type=nil)
        source = StringIO.new(source) unless source.is_a? StringIO
      ...
      private
        ...
        def read_typed_object source
          ...
          obj = RubyAMF::ClassMapping.ruby_object_for(class_name)
          @ref_cache << obj
          ...
          # Populate object
          RubyAMF::ClassMapping.populate_ruby_object(obj, props, {})
          return obj
        end
    end
      ...
      private
        ...
        def read_object source
          ...
          if isReference
            ...
            obj = RubyAMF::ClassMapping.ruby_object_for(traits[:class_name])
            @object_cache << obj
            ...
            if traits[:externalizable]
              ...
              RubyAMF::ClassMapping.populate_ruby_object(obj, props, dynamic_props)
            end
            obj
          end
        end
