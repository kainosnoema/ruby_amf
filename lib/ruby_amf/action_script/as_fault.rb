#this class takes a RUBYAMFException and inspects the details of the exception, returning this object back to flash as a Fault object

module RubyAMF
  module ActionScript
    class ASFault < RubyAMF::VoHelper::VoHash
